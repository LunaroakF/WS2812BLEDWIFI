            ...
            while True:
                try:
                    ...
                    if maindata == "offall":
                        ...
                        for i in range(LED_COUNT):
                            RGBstr=group[i].split(",")
                            RGBint=(int(RGBstr[0]),int(RGBstr[1]),int(RGBstr[2]))
                            strip.setPixelColor(i, Color(int(RGBstr[0]),int(RGBstr[1]),int(RGBstr[2])))
                            #pixels_set(i,RGBint)
                        #brightness=int(group[NUM_LEDS])
                        strip.show()
